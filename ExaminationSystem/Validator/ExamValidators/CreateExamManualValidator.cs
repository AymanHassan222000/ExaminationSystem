...
{
    public class CreateExamManualValidator : AbstractValidator<CreateExamManualViewModel>
    {
        public CreateExamManualValidator()
        {
            // Title Validation
            RuleFor(e => e.Title)
            ...
            RuleFor(e => e.QuestionIDs)
                .Must(e => e.Count >= 1).WithMessage("Questions must be greater than or equal 1 question.");

...
public class ResultEvaluationService : IResultEvaluationService
{
    ...
    private readonly IBaseRepository<ExamResult> _examResultRepo;
    ...
    public ResultEvaluationService(IMapper mapper,
        ...
        IBaseRepository<ExamResult> examResultRepo,
    ...
    public async Task<IEnumerable<ExamResultSummaryDTO>> GetAllStudentResultAsync(int examID, int instructorID)
    {
        ...
        ).Select(r => new ExamResultSummaryDTO
        {
            ...
            StudentInfo = new GetStudentInfoDTO
            {
                ...
                StudentName = $"{r.ExamAttempt.Student.User.FirstName} {r.ExamAttempt.Student.User.LastName}"
            }
        }).ToListAsync();
    ...
    {
        var examAttempt = await _examAttemptRepo.GetById(examAttemptID)
                                                .Include(m => m.Exam)
                                                .Include(m => m.ExamResult)
                                                .FirstOrDefaultAsync();
